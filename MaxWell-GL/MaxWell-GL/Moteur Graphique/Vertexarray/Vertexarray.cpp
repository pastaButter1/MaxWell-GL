...
void Vertexarray::ajouterAttribut(Vertexarray vao, Vertexbuffer vbo, uint32_t index, uint32_t taille, uint32_t type, bool normalizer, uint32_t pas, uint32_t decalage)
{
	lier(vao);
